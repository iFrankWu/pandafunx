...
namespace pandafun
{
    ...
    static const int64_t props_price = 250;
    static const int64_t panda_price = 2000;
    static const int32_t discount_num = 10;
    ...
    // @abi action, listen for eosio.token::transfer, handle the panda/book/candle/tea deal
    struct transfer
    {
        account_name from;
        account_name to;
    ...
    struct login {
        ...
        EOSLIB_SERIALIZE(login, (eos_account));
    };

    //@abi action signin
    struct signin {
        account_name eos_account;
        EOSLIB_SERIALIZE(signin, (eos_account));
    };
